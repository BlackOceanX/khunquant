...
const (
	...
	DescFuturesGetFunding         = "Check current funding rate and optional funding-fee history for a Binance or OKX perpetual futures symbol."
	DescFuturesValidateMarket     = "Validate that a Binance or OKX perpetual swap symbol is active and tradeable, with contract size, leverage limits, and fee information."
